...
import {reverseParseTextView} from '../../../judge/createRender';
                        ...
                        <div className="exercise-options">
                            {
                                data.item_list.map((val, key) =>
                                    <div key={key} className="exercise-option">
                                        ...
                                        <div className="exercise-option-item"
                        ...
                        <div className="footer-hide relative">
                            <div>
                                ...
                                <div className="inline-block" style={{width: '80%'}}>
                                    <span style={{fontSize: 14}} dangerouslySetInnerHTML={this.createHtml(data.answer)}/>
                                </div>
                            </div>
                            {
                                data.explain && <div>
